...
class ArtistRepository implements RepositoryInterface
{
     ...
     *
     * @param \Condominio\Entity\Artist $artist
     */
     ...
     * @param integer $id
     *
     * @return \Condominio\Entity\Artist|false An entity object if found, false otherwise.
     */
     ...
     *
     * @return \Condominio\Entity\Artist
     */
